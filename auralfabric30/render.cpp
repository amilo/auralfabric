...
static const char* filenames[] = { 
                                  "aural30sec-018-A00.wav"     //A_0
                                  ,"aural30sec-009-A01.wav"     //A_1
                                  ,"aural30sec-009-A01.wav"                  //A_2
                                  ,"aural30sec-017-A03.wav"     //A_3
                                  ,"waves.wav"                  //A_4
                                  ,"aural30sec-016-A05.wav"     //A_5
                                  ,"aural30sec-012-A06.wav"     //A_6
                                  ,"aural30sec-006-A07.wav"     //A_7  //
                                  ,"aural30sec-011-A08.wav"     //A_8  // chapel
                                  ,"aural30sec-004-A09.wav"     //A_9 //mary court
                                  ,"aural30sec-003-A10.wav"     //A_10
                                  ,"aural30sec-008-A11.wav"     //A_11
                                  ,"aural30sec-013-B00.wav"     //B_0
                                  ,"waves.wav"                  //B_1
                                  ,"aural30sec-010-B02.wav"     //B_2
                                  ,"aural30sec-015-B03.wav"     //B_3
                                  ,"waves.wav"                  //B_4
                                  ,"aural30sec-007-B05.wav"     //B_5
                                  ,"aural30sec-005-B06.wav"     //B_6
                                  ,"waves.wav"                  //B_7
                                  ,"aural30sec-001-B08.wav"     //B_8
                                  ,"aural30sec-002-B09.wav"     //B_9
                                  ,"waves.wav"                  //B_10
                                  ,"aural30sec-014-B11.wav"     //B_11
                                 };
...
void render(BelaContext *context, void *userData)
{
	...
	if(++readCount  * context->audioFrames >= readIntervalSamples) {
		readCount = 0;
    ...
    for(unsigned int n = 0; n < context->audioFrames; n++) {
        ...
        float outLog = 0;
        uint32_t samples = n + context->audioFramesElapsed;
        if(samples % 44100 == 0){
        	uint32_t seconds = samples / context->audioSampleRate;
        	uint32_t minutes = seconds / 60;
        	rt_printf("Time: %5u:%02u", minutes, seconds % 60);
        	//if(minutes == 10){
        	//	gShouldStop = 1;
        	//}
        }
